...
def mono_signal_processor(frame_time_ms):
    ...
    fourier_frame_builder = madmom.audio.signal.FramedSignalProcessor(frame_size=frame_size, fps=FRAMES_PER_SECOND) # framing for the fourier transform
    ...
    context_builder = madmom.audio.signal.FramedSignalProcessor(frame_size=CONTEXT_TIME_MS/STEP_SIZE, hop_size=1)
